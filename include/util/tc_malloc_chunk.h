...
namespace tars
{
    ...
    */
    ...
    {
    public:
        TC_SpanAllocator() : _pHead(nullptr), _pData(nullptr) {}
    ...
    */
    ...
    public:
        TC_Page() : _pShmFlagHead(nullptr),_pModifyHead(nullptr),_pCenterCache(nullptr),_pLarge(nullptr),_pFree(nullptr),_pSpanMemHead(nullptr),_pPageMap(nullptr),_pData(nullptr) {}
    ...
    {
    public:
        TC_MallocChunkAllocator():_pHead(nullptr),_pChunk(nullptr),_nallocator(nullptr) {}
    ...
    protected:
        ...
        //禁止copy构造
        TC_MallocChunkAllocator(const TC_MallocChunkAllocator &) = delete;

        //禁止复制
        TC_MallocChunkAllocator& operator=(const TC_MallocChunkAllocator &) = delete;
